...
public class UploadDialogController {
    ...
    private void handleSelectFile() {
        ...
        // Filtre par défaut : Tous les fichiers autorisés
        FileChooser.ExtensionFilter allAllowedFilter = new FileChooser.ExtensionFilter("Tous les fichiers autorisés",
                "*.jpg", "*.jpeg", "*.png", "*.webp", "*.pdf", "*.doc", "*.docx", "*.xlsx", "*.pptx", "*.zip", "*.txt", "*.csv");
        
        fileChooser.getExtensionFilters().addAll(
                allAllowedFilter,
                new FileChooser.ExtensionFilter("Images", "*.jpg", "*.jpeg", "*.png", "*.webp"),
                new FileChooser.ExtensionFilter("Documents PDF", "*.pdf"),
                new FileChooser.ExtensionFilter("Documents Office", "*.doc", "*.docx", "*.xlsx", "*.pptx"),
                new FileChooser.ExtensionFilter("Archives & Textes", "*.zip", "*.txt", "*.csv"),
                new FileChooser.ExtensionFilter("Tous les fichiers (*.*)", "*.*")
        );

        // Forcer la sélection du filtre "Tous les fichiers autorisés"
        fileChooser.setSelectedExtensionFilter(allAllowedFilter);
    ...
    private void handleUpload() {
        ...
        // targetFolderId peut être null (racine)
