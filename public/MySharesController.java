...
public class MySharesController {
    ...
    @FXML private TableColumn<ShareItem, String> descriptionCol;
    ...
    private void initialize() {
        ...
        resourceCol.setCellValueFactory(data ->
                new javafx.beans.property.SimpleStringProperty(
                        (data.getValue().getLabel() != null && !data.getValue().getLabel().isBlank())
                                ? data.getValue().getLabel()
                                : data.getValue().getResource()
                ));

        descriptionCol.setCellValueFactory(data -> {
            String desc = data.getValue().getDescription();
            return new javafx.beans.property.SimpleStringProperty((desc != null && !desc.isBlank() && !desc.equals("null")) ? desc : "-");
        });

        labelCol.setCellValueFactory(data -> {
            String note = data.getValue().getRecipientNote();
            return new javafx.beans.property.SimpleStringProperty((note != null && !note.isBlank() && !note.equals("null")) ? note : "-");
        });
    ...
    private void refresh() {
        System.out.println("MySharesController - refresh() appelé");
    ...
    private void initActionColumn() {
        ...
        actionCol.setCellFactory(col -> new TableCell<ShareItem, Void>() {
...

            {
                ...
                revokeBtn.getStyleClass().add("button-danger");
                deleteBtn.getStyleClass().add("button-danger");

                //tooltip
                copyBtn.setTooltip( new Tooltip("Copier le lien"));
                revokeBtn.setTooltip( new Tooltip("Révoquer"));
