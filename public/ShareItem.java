...
public class ShareItem {
    ...
    /**
     * @return Résumé de la description + note pour l'historique
     */
    public String getNotesSummary() {
        ...
        if (recipientNote != null && !recipientNote.isBlank() && !recipientNote.equals("null")) {
            if (sb.length() > 0) sb.append(" — ");
            sb.append("(Note: ").append(recipientNote).append(")");
        }
