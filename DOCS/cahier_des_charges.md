...
```mermaid
gantt
    title Planning du Projet ObsiLock (7 jours)
    dateFormat  YYYY-MM-DD
    section Jour 1 — Cadrage
    OpenAPI v1 & Contrat d'API     :done, j1a, 2026-02-10, 1d
    Squelette Slim + Medoo          :done, j1b, 2026-02-10, 1d
    Initialisation Git & CI         :done, j1c, 2026-02-10, 1d

    section Jour 2 — Fichiers & Dossiers
    API Auth (register/login JWT)   :done, j2a, 2026-02-11, 1d
    Endpoints Dossiers              :done, j2b, 2026-02-11, 1d
    Upload chiffré (LibSodium)      :done, j2c, 2026-02-11, 1d
    Squelette JavaFX + Login        :done, j2d, 2026-02-11, 1d

    section Jour 3 — Partages
    Liens de partage sécurisés      :done, j3a, 2026-02-12, 1d
    Journal des téléchargements     :done, j3b, 2026-02-12, 1d
    UI Partages (JavaFX)            :done, j3c, 2026-02-12, 1d

    section Jour 4 — Versioning
    Endpoint nouvelle version       :done, j4a, 2026-02-13, 1d
    Métadonnées versions            :done, j4b, 2026-02-13, 1d
    UI Versions (JavaFX)            :done, j4c, 2026-02-13, 1d

    section Jour 5 — Sécurité & Finitions
    Headers sécurité & CORS strict  :done, j5a, 2026-02-14, 1d
    Rate-Limiting                   :done, j5b, 2026-02-14, 1d
    Pagination & quotas UI          :done, j5c, 2026-02-14, 1d

    section Jour 6 — Stabilisation & Doc
    Tests unitaires & intégration   :done, j6a, 2026-02-15, 1d
    Documentation installation      :done, j6b, 2026-02-15, 1d
    Procédure sauvegarde/restore    :done, j6c, 2026-02-15, 1d

    section Jour 7 — Soutenance
    UI Thème Switch (Premium)       :done, j7a, 2026-03-21, 1d
    Déploiement production          :done, j7b, 2026-03-21, 1d
    Documentation finale            :active, j7c, 2026-03-22, 1d
```
