...
//        }
    ...
    public List<FileEntry> getTrashFiles() throws Exception {
        String json = get("/trash/files");
        com.fasterxml.jackson.databind.JsonNode root = mapper.readTree(json);
        if (root.has("data")) {
            return mapper.readerForListOf(FileEntry.class).readValue(root.get("data"));
        }
        return mapper.readerForListOf(FileEntry.class).readValue(json);
    }
    ...
    public List<NodeItem> getTrashFolders() throws Exception {
        String json = get("/trash/folders");
        return mapper.readerForListOf(NodeItem.class).readValue(json);
    }
